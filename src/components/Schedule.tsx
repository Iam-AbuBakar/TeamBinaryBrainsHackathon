...
interface ScheduleProps {
  ...
  onBack: () => void; // <-- new prop to go back
}

export function Schedule({ educator, onComplete, onBack }: ScheduleProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between mt-8">
        <button
          onClick={onBack}
          className="flex items-center gap-2 px-5 py-3 rounded-lg bg-gray-100 text-gray-700 hover:bg-gray-200 transition"
        >
